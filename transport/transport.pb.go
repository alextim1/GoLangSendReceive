...
func (x *Empthy) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Empthy) ProtoMessage() {}

func (x *Empthy) ProtoReflect() protoreflect.Message {
	mi := &file_transport_proto_msgTypes[0]
...
// Deprecated: Use Empthy.ProtoReflect.Descriptor instead.
func (*Empthy) Descriptor() ([]byte, []int) {
...
type CarrierDto struct {
	...
	FibNumber int64 `protobuf:"varint,1,opt,name=fibNumber,proto3" json:"fibNumber,omitempty"`
}

func (x *CarrierDto) Reset() {
	*x = CarrierDto{}
	if protoimpl.UnsafeEnabled {
...
func (x *CarrierDto) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CarrierDto) ProtoMessage() {}

func (x *CarrierDto) ProtoReflect() protoreflect.Message {
	mi := &file_transport_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CarrierDto.ProtoReflect.Descriptor instead.
func (*CarrierDto) Descriptor() ([]byte, []int) {
	return file_transport_proto_rawDescGZIP(), []int{1}
}

func (x *CarrierDto) GetFibNumber() int64 {
	if x != nil {
		return x.FibNumber
	}
	return 0
...
var file_transport_proto_rawDesc = []byte{
	...
	,
...
var file_transport_proto_goTypes = []interface{}{
	(*Empthy)(nil),     // 0: transport.Empthy
	(*CarrierDto)(nil), // 1: transport.CarrierDto
}
var file_transport_proto_depIdxs = []int32{
	1, // 0: transport.Sender.Send:input_type -> transport.CarrierDto
	0, // 1: transport.Sender.Send:output_type -> transport.Empthy
...
type SenderClient interface {
	Send(ctx context.Context, in *CarrierDto, opts ...grpc.CallOption) (*Empthy, error)
}
...
func (c *senderClient) Send(ctx context.Context, in *CarrierDto, opts ...grpc.CallOption) (*Empthy, error) {
	out := new(Empthy)
	err := c.cc.Invoke(ctx, "/transport.Sender/Send", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SenderServer interface {
	Send(context.Context, *CarrierDto) (*Empthy, error)
}
...
func (*UnimplementedSenderServer) Send(context.Context, *CarrierDto) (*Empthy, error) {
...
func _Sender_Send_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/transport.Sender/Send",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SenderServer).Send(ctx, req.(*CarrierDto))
	}
	return interceptor(ctx, in, info, handler)
}

var _Sender_serviceDesc = grpc.ServiceDesc{
	ServiceName: "transport.Sender",
